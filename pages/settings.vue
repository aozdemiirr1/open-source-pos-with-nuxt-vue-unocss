      ...
      <div class="p-6 space-y-6">
        ...
        <div class="space-y-4 pt-6 border-t">
          ...
          <div class="grid grid-cols-1 gap-4">
            <div v-for="(hours, day) in settings.businessHours" :key="day" class="flex items-center gap-4">
              <span class="w-24 text-sm font-medium">{{ getDayName(day) }}</span>
              <input type="time" v-model="hours.open" class="rounded-lg border border-gray-300 px-3 py-2">
              <span>-</span>
              <input type="time" v-model="hours.close" class="rounded-lg border border-gray-300 px-3 py-2">
